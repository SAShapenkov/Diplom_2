...
class TestGetOrderForUser:
    ...
    def test_get_user_orders_authorized_user(self, make_user, create_order_payload, create_user_payload):
    ...
    def test_get_user_orders_unauthorized_user(self, make_user, create_order_payload, create_user_payload):
        user_payload = create_user_payload(email='rand', password='rand', name='rand')
        user = make_user(data=user_payload)
        order_payload = create_order_payload
    ...
    def test_get_user_orders_invalid_token(self, make_user, create_order_payload, create_user_payload):
        user_payload = create_user_payload(email='rand', password='rand', name='rand')
        user = make_user(data=user_payload)
        order_payload = create_order_payload
        token = user["text"]['accessToken']
